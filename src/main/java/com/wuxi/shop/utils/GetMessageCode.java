...
public class GetMessageCode {
	...
	private static final String ACCOUNT_SID = "f19801c9f7c243c48bb600d3149a4ee0";
	private static final String AUTH_TOKEN = "18974627f2664858860e2a7962cdb89d";
	    ...
	    public static String getCode(String phone){
	        ...
	        String tamp="【第四组网站】尊敬的用户，您的验证码为"+rod+"，如非本人操作，请忽略本短信。";//这里一定要与新建模板中的短信内容一致，一个空格都不能多，否者短信打死都发不过去哦
